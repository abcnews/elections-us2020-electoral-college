...
window.KeyshapeJS = (function () {
  ...
  function da(a, b, c, d) {
    if (0 == a)
      return (
        0 == b
          ? (b = -d / c)
          : ((a = Math.sqrt(c * c - 4 * b * d)),
            (d = (-c + a) / (2 * b)),
            0 <= d && 1 >= d ? (b = d) : ((d = (-c - a) / (2 * b)), (b = 0 <= d && 1 >= d ? d : 0))),
        b
      );
    var e = c / a - (b * b) / (a * a) / 3;
  ...
  function fa(a, b, c, d) {
    ...
    if (0 == a) return 0.5 > d ? b : c;
    if (48 == a) {
      if ('number' === typeof b && 'number' === typeof c) {
        var e = 1 - d;
        return (
          ((y(e * (b >>> 24) + d * (c >>> 24)) << 24) |
            (y(e * ((b >>> 16) & 255) + d * ((c >>> 16) & 255)) << 16) |
            (y(e * ((b >>> 8) & 255) + d * ((c >>> 8) & 255)) << 8) |
            y(e * (b & 255) + d * (c & 255))) >>>
          0
        );
      }
    ...
    if (96 == a) {
      if (b.length != c.length) return 0.5 > d ? b : c;
      n = b.length;
      l = [];
      for (a = 0; a < n; a += 2) {
        if (b[a] !== c[a]) return 0.5 > d ? b : c;
        l[a] = b[a];
        l[a + 1] = [];
        for (f = 0; f < b[a + 1].length; ++f) l[a + 1].push((c[a + 1][f] - b[a + 1][f]) * d + b[a + 1][f]);
      }
      return l;
    }
    if (80 == a) {
      n = b.length;
      if (n != c.length) return 0.5 > d ? b : c;
      l = [];
      for (a = 0; a < n; ) {
        if (b[a] != c[a] || 1 == b[a]) return 0.5 > d ? b : c;
        l[a] = b[a];
  ...
  function O(a) {
    if (a || !E) {
      for (var b = !1, c = 0; c < w.length; ++c) w[c].J(a) && (b = !0);
      if (a)
        for (; 0 < I.length; )
          if (((a = I.shift()), (c = a[0]), 1 == a[1])) c.onfinish && (c.onfinish(), (b = !0)), c.I();
          else if (2 == a[1] && c.onloop) c.onloop();
      return b;
    }
  }
  function W() {
  ...
  function ha(a) {
    return Array.isArray(a)
      ? a
      : x(a, 'cubic-bezier(')
      ? ((a = a.substring(13, a.length - 1).split(',')),
        [1, parseFloat(a[0]), parseFloat(a[1]), parseFloat(a[2]), parseFloat(a[3])])
      : x(a, 'steps(')
      ? ((a = a.substring(6, a.length - 1).split(',')), [a[1] && 'start' == a[1].trim() ? 2 : 3, parseFloat(a[0])])
      : [0];
  }
  function ia(a) {
    a = a.trim();
    return x(a, '#')
      ? (parseInt(a.substring(1), 16) << 8) + 255
      : x(a, 'rgba(')
  ...
  Z.prototype = {
    B: function (a) {
      ...
      if (null !== this.c) {
        var c = this.j();
        0 < this.b && null !== c && c >= this.f
          ? this.h
            ? ((this.c = v - this.g / this.b), this.h--, (b = 2))
            : ((b = 1), a ? (this.a = c) : (this.a = this.s ? Math.max(this.s, this.f) : this.f))
          : 0 > this.b && null !== c && c <= this.g
          ? this.h && Infinity != this.f
            ? ((this.c = v - this.f / this.b), this.h--, (b = 2))
            : ((this.h = 0), (b = 1), a ? (this.a = c) : (this.a = this.s ? Math.min(this.s, this.g) : this.g))
    ...
    J: function (a) {
      a &&
        (this.o &&
          ((this.o = !1),
          null === this.c &&
            (0 != this.b && null !== this.a ? ((this.c = v - this.a / this.b), (this.a = null)) : (this.c = v))),
        null === this.a && null !== this.c && ((a = this.B(!1)), 0 != a && I.push([this, a])));
      a = this.j();
      if (null === a) return !1;
          ...
          if (null !== h) {
            ...
            g =
              0 == m
                ...
                : U((a - g) % m, f);
            0 == h
              ? ((e._ks.mpath = f[8]), (e._ks.transform[h] = g), (n = !0))
              : 14 >= h
              ? ((e._ks.transform[h] = g), (n = !0))
              : ((g = ea(f[1] & 240, g)), f[1] & 1 ? e.setAttribute(h, g) : (e.style[h] = g));
          }
        }
        if (n) {
          Y(e);
          ...
          if ((f = e._ks.mpath))
            (g = n[0]),
              ...
              100 < g && (g = 100),
              (g = (g * f[2]) / 100),
              (h = f[1].getPointAtLength(g)),
              (l = 'translate(' + h.x + ',' + h.y + ') '),
              f[0] &&
                (0.5 > g ? ((g = h), (h = f[1].getPointAtLength(0.5))) : (g = f[1].getPointAtLength(g - 0.5)),
                (l += 'rotate(' + (180 * Math.atan2(h.y - g.y, h.x - g.x)) / Math.PI + ') '));
    ...
    D: function () {
      if (!this.F) {
        ...
        for (var a = this.A, b = this.C, c = 0; c < a.length; ++c)
          for (var d = a[c], e = 0; e < b[c].length; ++e) 14 >= b[c][e][0] && Y(d);
      }
    },
    u: function (a) {
    ...
    play: function (a) {
      t(a) &&
        ...
        ((a = this.u(a)),
        H(a),
        0 > this.b && a < this.g && (a = this.g),
        0 < this.b && a > this.f && (a = this.f),
        this.w(a, !0));
      if (!this.i) throw Q;
      a = this.j();
      if (0 < this.b && (null === a || a >= this.f)) this.a = this.g;
    ...
    range: function (a, b) {
      if (0 == arguments.length) return { in: this.g, out: this.f };
      var c = this.u(a),
        d = this.v;
      t(b) && (d = this.u(b));
      H(c);
    ...
    w: function (a, b) {
      ...
      null !== a &&
        (this.D(),
        null !== this.a || null === this.c || 0 == this.b ? ((this.a = a), O(!1)) : (this.c = v - a / this.b),
        this.i || (this.c = null),
        (this.s = null),
        this.B(!0),
        N());
    ...
    m: function () {
      ...
      return this.o
        ...
        : null === this.c
        ? 'paused'
        : (0 < this.b && a >= this.f) || (0 > this.b && a <= this.g)
        ? 'finished'
        : 'running';
    },
    state: function () {
  ...
  return {
    ...
    animate: function () {
      ...
      for (var d = (b = 0); d < a.length - 1; d += 2) {
        ...
        for (var l = [], f = 0; f < n.length; ++f) {
          var h = n[f],
            g = J(h, 'p', 'property');
          if ('string' != typeof g || -1 != g.indexOf('-') || '' === g || !(0 < S[g] || 0 <= ba.indexOf(g)))
            throw Error('Invalid property: ' + g);
          var q = ba.indexOf(g);
          '' !== g && 0 <= q && (g = q);
          q = R(g);
          var m = J(h, 't', 'times');
          ...
          for (var C = g, k = u, w = R(C) & 240, p = 0; p < k.length; ++p)
            if (96 == w) {
              for (
                var G = k[p].substring(6, k[p].length - 2).match(/[A-DF-Za-df-z][-+0-9eE., ]*/gi), A = [], r = 0;
                r < G.length;
                ++r
              ) {
                A.push(G[r][0]);
              ...
              x(k[p], '#')
                ? ((G = 9 == k[p].length), (k[p] = parseInt(k[p].substring(1), 16)), G || (k[p] = (256 * k[p]) | 255))
                : x(k[p], 'url(') || 'none' == k[p] || (console.warn('unsupported color: ' + k[p]), (k[p] = 0));
            else if (80 == w) {
              G = k;
              A = p;
              r = k[p];
              if ('none' == r) r = [0];
                ...
                for (var D = r.indexOf('('); 0 < D; )
                  if (((F = T.indexOf(r.substring(0, D))), 0 <= F)) {
                    ...
                    5 == F
                      ? (z.push(parseFloat(D[0])), z.push(parseFloat(D[1])), z.push(parseFloat(D[2])), z.push(ia(D[3])))
                      : 1 == F
                      ? z.push(D[0])
                      : z.push(parseFloat(D[0]));
              ...
              64 == w
                ? 'none' != k[p]
                  ? /^[0-9 .]*$/.test(k[p])
                    ? (k[p] = X(k[p], ' '))
                    : (console.warn('unsupported value: ' + k[p]), (k[p] = [0]))
                  : (k[p] = [0])
                : 32 == w
                ? (H(k[p]), (k[p] = parseFloat(k[p])))
                : 0 === C && (k[p] = parseFloat(k[p]));
          C = J(h, 'e', 'easing');
          k = m.length;
          for (C || (C = []); C.length < k; ) C.push([1, 0, 0, 0.58, 1]);
          for (k = 0; k < C.length; ++k) C[k] = ha(C[k]);
          q = [g, q, B, v, m, u, C, y];
          m = J(h, 'mp', 'motionPath');
          t(m) &&
            0 === g &&
            ((q[8] = []),
            (q[8][0] = h.motionRotate),
            (h = document.createElementNS('http://www.w3.org/2000/svg', 'path')),
            m || (m = 'M0,0'),
            h.setAttribute('d', m),
            (q[8][1] = h),
            (q[8][2] = h.getTotalLength()));
          l.push(q);
        }
    ...
    remove: P,
    removeAll: function () {
      for (var a = w.length - 1; 0 <= a; --a) P(w[a]);
      return this;
    },
    timelines: function () {
      return w.slice();
